...
define config.name = "Doki Doki Murder Case! [v2.4.1] For Windows"
...
init python:
    if ddmm_online:
        config.name = "Doki Doki Murder Case! [v2.4.1] For Windows (using DDMM)"
    else:
        config.name = "Doki Doki Murder Case! [v2.4.1] For Windows"
